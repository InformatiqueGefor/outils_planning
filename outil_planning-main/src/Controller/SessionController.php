...
class SessionController extends AbstractController
{
    ...
    #[Route('/session/{id}', name: 'app_session_show', methods: ['GET'])]
    ...
    #[Route('/session/{id}/edit', name: 'app_session_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/session/{id}', name: 'app_session_delete', methods: ['POST'])]
